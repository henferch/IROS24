...
%	
	...
	\end{table}
		...
		\begin{figure}[h!]
			...
			\begin{tikzpicture}
			\node [] at (0,0){
				\includegraphics[scale=1.1,keepaspectratio]{fig/sim_objs.png}};
			...
			\end{scope}			
			\node at (0.0,2.7) [color=black] {\small \textbf{Simulated bottom-up stimulation}};
