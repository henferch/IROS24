...
%	\end{figure}
	...
	\begin{figure}[h!]
		\begin{tikzpicture}
		\node [] at (0,0){
			\includegraphics[scale=0.39,keepaspectratio]{fig/model.eps}};
...
%	
	...
	\end{table}
		...
		\begin{figure}[h!]
			...
			\node at (0.0,2.7) [color=black] {\small \textbf{Local stimulation}};
			...
			\end{scope}
			\end{tikzpicture}
			\caption{Stimulation was simulated at six locations in the sensory ego-space. Objects' center coordinates $\mathbf{p}_i$ and corresponding projection $\mathbf{\hat{p}}_i$ on the sensory ego-space are shown. }
			\label{fig:sim_objs}
			\end{center}
		\end{figure}
