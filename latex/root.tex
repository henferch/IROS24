...
\begin{figure}[h!]
	\begin{center}
		...
		\node at (-0.4,3.3) [color=black] {\small \textbf{Hebbian learning}};
		
		% removing unwanted labels
		\filldraw[draw=white,color=white] (-4.4,2.5) rectangle (3.7,2.7);	
		\filldraw[draw=white,color=white] (-4.4,-2.5) rectangle (3.7,-2.7);	
		
		\node at (-4.0,2.7) [color=black] {\scriptsize Activity at $\mathbf{\hat{p}}_1$};
		\node at (-1.7,2.7) [color=black] {\scriptsize Activity at $\mathbf{\hat{p}}_2$};
		\node at (0.7,2.7) [color=black] {\scriptsize Activity at $\mathbf{\hat{p}}_3$};
		\node at (2.9,2.7) [color=black] {\scriptsize Activity at $\mathbf{\hat{p}}_4$};
		...
		\node at (2.9,2.7) [color=black] {\scriptsize $\mathbf{u}_{\mathrm{r}(t)}$};
...
\end{figure}
	...
	\begin{figure}[h!]
		\begin{center}
			\begin{tikzpicture}
			\node [] at (0,0){
				\includegraphics[scale=0.5,keepaspectratio]{fig/sim2_around_lr.pdf}};
			\node at (0.0,4.6) [color=black] {\small \textbf{Searching around operators}};
